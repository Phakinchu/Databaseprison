...
<div class="blog-header">
  ...
  @foreach ($posts as $post)
    ...
    <tr>
      ...
      <td><center>{{$post->position}}</center></td>
			...
			<td><center><a href="/officers/{{$post->id_officer}}/editpage">Click</a></center></td>
			<td><center><a href="/officers/{{$post->id_officer}}/delete">Click</a></center></td>
			</tr>
    </table><br> 
  ...
  @endforeach
	...
	<form action="/officers/gender/{{$gender}}" method="post">
		Gender :	<input type="text" name="gender" > <input type="submit" name="submit" value="Go with ur mom">
		</form>
